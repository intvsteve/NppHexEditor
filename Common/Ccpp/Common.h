...
protected:
	...
	WcharMbcsConvertor& operator= (const WcharMbcsConvertor&) { return *this; } // = delete;

	// No move ctor and assignment
	WcharMbcsConvertor(WcharMbcsConvertor&&) {} // = delete;
	WcharMbcsConvertor& operator= (WcharMbcsConvertor&&) { return *this; } // = delete;

	template <class T>
	class StringBuffer final
	{
	public:
		StringBuffer() : _allocLen(0), _str(nullptr)
		{}
